<template>
  <main class="flex justify-center py-16 screenHeight">
    <section
      class="max-w-4xl w-5/6 flex justify-center items-center flex-col gap-4"
    >
      ...
      <div v-if="cartItems.length" class="w-full flex flex-col gap-10">
        <div class="flex flex-col gap-5">
          <div
            ...
            class="p-4 border border-gray-300 rounded-lg flex items-center"
          >
            <div
              class="w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center flex-shrink-0"
            >
              <img
                :src="product.image"
                :alt="product.title"
                class="w-14 sm:w-16 object-cover"
              />
            </div>
            ...
            <div class="w-full grid place-items-center">
              <div class="px-6 flex flex-col justify-between gap-3 w-full">
                <div class="flex flex-col sm:flex-row justify-between">
                  ...
                  <p class="font-bold sm:text-xl sm:pl-4">
      ...
      <div v-if="!cartItems.length" class="flex flex-col gap-4">
        <p class="text-center text-2xl">Your carrito esta vacío</p>
